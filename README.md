...
Training/
├── Week1/
│   ├── Day1/ - Streams and buffer concepts
│   ├── Day2/ - Benchmarking and performance
│   ├── Day3/ - Reference materials
│   ├── Day4/ - API investigation
...
├── Week7/
│   ├── Day1/ - LOCAL RAG SYSTEM + PIPELINE ARCHITECTURE
│   ├── Day2/ - ADVANCED RETRIEVAL + CONTEXT ENGINEERING
