...
def build_text_input(ocr_text: str, caption: str):
    """
    Combine OCR + Caption safely for CLIP.
    Caption first (more important for images).
    """
...
def generate_clip_embeddings():
    """
    Generate CLIP embeddings for:
    - Images
    - Image-associated text (Caption + OCR)
    """
